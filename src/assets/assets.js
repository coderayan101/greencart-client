...
import { TruckIcon, LeafIcon, ShieldCheckIcon, TractorIcon } from "lucide-react";
...
export const heroSectionData = {
  hero_features: [
    {
      icon: TractorIcon,
      title: "চাষির কাছ থেকে সরাসরি",
      desc: "কোনো মধ্যস্বত্বভোগী নেই",
    },
    {
      icon: LeafIcon,
      title: "তাজা ও প্রাকৃতিক",
      desc: "সরাসরি ক্ষেত থেকে",
    },
    {
      icon: TruckIcon,
      title: "ফ্রি ডেলিভারি",
