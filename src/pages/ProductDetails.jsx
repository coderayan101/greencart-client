      ...
      <div className="mt-8 md:mt-12 px-6 md:px-16 lg:px-24 xl:px-36">
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16 mt-4">
          ...
          <div className="text-sm w-full md:w-1/2 md:mt-8">
            ...
            <p className="text-sm text-gray-500/70 font-medium mt-1">
              ওজন: {product.weight}
            </p>
            ...
            <div className="mt-4 md:mt-6">
              ...
              <p className="text-2xl font-medium">
                MRP: {currency}
                {product.offerPrice}{" "}
                <span className="text-gray-500/70 line-through text-lg">
                  {currency}
                  {product.price}
                </span>
              </p>
            ...
            <p className="text-sm font-bold mt-4 md:mt-6">
              পণ্য সম্পর্কিত তথ্য
            </p>
        ...
        <div className="flex flex-col items-center mt-10 md:mt-20">
          ...
          <button
            ...
            className="mx-auto cursor-pointer px-12 my-10 md:my-16 py-2.5 border rounded-lg text-primary hover:bg-primary/10 transition"
          >
            আরও দেখুন
          </button>
        </div>
